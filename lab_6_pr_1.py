...
def astroida(a, R):
    """Функция строит астроиду: кривая, некоторой точки окружности радиуса R/4, катящейся без скольженияпо другой окружности радиуса R причем меньшая оркужность все время остается внутри большей.
       На вход подаются:
